...
def predict(X_frame, knn_clf=None, model_path=None, distance_threshold=0.040):
    ...
    X_face_locations = face_recognition.face_locations(X_frame,model="hog")
...
def attendance(predictions):
    ...
    try:
        df = pd.read_csv('/home/srec/Desktop/FaceRPI/'+get_date()+".csv")
        #print("read")
    except:
...
def show_prediction_labels_on_image(frame, predictions):
    ...
    try:
        ...
        if predictions[0][0]not in Namelst and predictions[0][0] !="unknown":
            ...
            df1.to_csv('/home/srec/Desktop/FaceRPI/'+get_date()+".csv",index=False)
...
def Train_Recognize(thresh):
    ...
    while 1 > 0:
        ...
        if process_this_frame % 60 == 0:
            predictions1 = predict(img, model_path="/home/srec/Desktop/FaceRPI/trained_knn_model.clf", distance_threshold=thresh)
        ...
        if get_time()=="10:30" or get_time()=="19:50":
            print('time up')
            if get_time()=="10:30":
                break
            elif get_time()=="19:50":
                storage.child("/Attendance/"+get_date()+"_6.csv").put('/home/srec/Desktop/FaceRPI/'+get_date()+".csv")
            break
