...
with open('/home/srec/Desktop/FaceRPI/mb_device1/configs/threshold.txt', 'r') as f:
    thresh = float(f.read())
...
if __name__ == '__main__':
    ...
    img = Image.open("/home/srec/Desktop/FaceRPI/mb_device1/data/Visgenix Logo-01.png")
